...
@Service
public class EstatisticaOriginal implements ICalculoEstatistica{
    private IEventoRepository eventoRep;

    @Autowired
    public EstatisticaOriginal(IEventoRepository eventoRep){
        this.eventoRep = eventoRep;
        System.out.println("Calcula AnoCorrente");
    }

    
    @Override
    public EstatisticasDTO CalculoOriginal(int distancia){
